...
async function loadSettings() {
    ...
    setValue('movementReceiveCode', movement.receiveCode);
    setValue('movementPayCode', movement.payCode);
    setValue('movementCounterpartyAccount', movement.counterpartyAccount || '99999999999999999999');
    setValue('movementCounterpartyName', movement.counterpartyName || '一户通挡板虚拟对手');
    setValue('movementCounterpartyBank', movement.counterpartyBank || '999999999999');
...
async function saveSettings() {
    const payload = {
        ...
        movement: {
            ...
            counterpartyAccount: valueOf('movementCounterpartyAccount'),
            counterpartyName: valueOf('movementCounterpartyName'),
            counterpartyBank: valueOf('movementCounterpartyBank'),
    ...
    if (result.ok) state.settings = result.body;
    await loadOverview();
}
